...
export const PREGUNTAS = [
  ...
  },
  {
    ...
    a: 'Imagina que las 365 o 366 casillas son una barra dividida en partes iguales. La barra entera representa el coste laboral anual. Una casilla representa 1/365 o 1/366 de ese coste, aunque tenga escrita una fecha. Sumamos el IRPF estimado y las cotizaciones de la empresa y del trabajador; esa suma es la cuña fiscal. La dividimos entre el coste laboral para saber qué porcentaje de la barra corresponde a la cuña. Multiplicamos ese porcentaje por el número de casillas para saber cuántas pintar. Las que quedan sin relleno representan la parte del salario neto.\n\nDentro de las casillas pintadas, los tres colores muestran cómo se repartirían si aplicáramos los porcentajes del gasto público español de 2023 según COFOG. Una casilla de un color identifica una categoría de esa comparación, no el destino real de tu IRPF en esa fecha. Pintamos desde enero sólo para contar: ninguna fecha señala un día trabajado para una institución o un pago de impuestos. El cálculo con tus cifras aparece en «Cómo está calculado», método M4.'
  },
