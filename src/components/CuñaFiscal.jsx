  ...
  return (
    <div className="card-glass p-4 shadow-2xl text-xs min-w-[220px]" style={{ backdropFilter: 'blur(24px)' }}>
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="font-bold text-white text-[13px]">{seg.label}</span>
      </div>
      <p className="font-mono text-white text-[15px] font-black">{eur(d.value)}</p>
      <p className="text-[10px] mt-1" style={{ color: d.fill }}>{pct}% del coste total para la empresa</p>
      <p className="text-[10px] text-[#64748b] mt-1 leading-relaxed">{seg.desc}</p>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-5">
        <div>
          <h2 className="text-xl font-extrabold text-white tracking-tight">Cuña fiscal</h2>
          <p className="text-sm text-[#7a8baa] mt-1">
            Cómo se reparte cada euro de tu sueldo entre <strong className="text-white font-semibold">tú</strong>, <strong className="text-red-400 font-semibold">Hacienda</strong> y la <strong className="text-amber-400 font-semibold">Seguridad Social</strong>.
          </p>
        </div>
        {/* Toggle vista */}
      ...
      <div className="info-card mb-5 text-[13px] text-[#94a3b8] leading-relaxed">
        {vista === 'trabajador' ? (
          <>
            <strong className="text-white font-semibold">Vista trabajador:</strong> muestra cómo se divide tu{' '}
            <strong className="text-white">bruto ({eur(r.bruto)})</strong> — lo que aparece en tu contrato.
            La diferencia entre bruto y neto la conforman el IRPF y tu cuota de SS.
          </>
        ) : (
          <>
            <strong className="text-white font-semibold">Vista empresa:</strong> muestra el{' '}
            <strong className="text-white">coste laboral real ({eur(r.costeLab)})</strong> — lo que la empresa paga en total.
            Incluye además la SS patronal (~31,5% del bruto), que el trabajador normalmente no ve en su nómina.
          </>
        )}
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-center">
        ...
        <div className="relative shrink-0" style={{ width: 280, height: 280 }}>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            <p className="text-[10px] text-[#64748b] font-semibold uppercase tracking-wider">Neto</p>
            <p className="text-2xl font-black text-white font-mono leading-none">{pctNeto}%</p>
            <p className="text-[10px] text-[#64748b] mt-0.5">{eur(r.salarioNeto)}</p>
          </div>
        </div>
        ...
        <div className="flex-1 w-full space-y-3">
              ...
              <div key={d.name}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className="font-mono font-bold text-white text-[13px]">{eur(d.value)}</span>
                ...
                <p className="text-[10px] text-[#64748b] mt-1.5 leading-relaxed">{seg.desc}</p>
              </div>
            );
          })}
          ...
          <div className="rounded-xl p-3.5 border mt-2"
            ...
            <div className="flex justify-between items-center text-xs">
              <span className="text-[#64748b] font-semibold uppercase tracking-wider">
                {vista === 'trabajador' ? 'Sueldo bruto contractual' : 'Coste laboral total empresa'}
              </span>
              <span className="font-mono font-black text-white text-[14px]">{eur(total)}</span>
            </div>
